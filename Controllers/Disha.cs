    ...
    class Disha
    {
        ...
        public static string syncOdbc(IProgress<int> progress)
        {
            try
            {
                ...
                if (rCnt > 0)
                {
                    int liInsType, liTableType, liCreateTable = 0, liBrLoop, liBrCount = 0, liLoop, llAddDays, iiProgress1, iiProgress2, liFIrstIns, iiAddDays = 0;
                    ...
                    for (int i = 0; i < rCnt; i++)
                    {
                        ...
                        iiBr = (lsFetchTable.Contains("@brCode") ? 1 : 0 );
                        ...
                        for (int br = 0; br < liBrLoop; br++)
                        {
                            ...
                            ZeroRows:
                                if (liTableRowCount > 0)
                                {
                                    ...
                                    SqlDataReader _lsdrData;
                                    DataTable _ldtData = new DataTable();
                                    try
                                    {
                                        _lsdrData = _OdbcSyncParam.odbcGlobalVar.odbcConn.destDBExecRetMultiple(isSqlQuery, out isReturn);
                                        if (isReturn != "Success")
                                        {
                                            _OdbcSyncParam.setStatusLog("status", isReturn, 1);
                                            _OdbcSyncParam.auditLogReset(4);
                                    ...
                                    {
                                        //////////////////////////////////////////////////////////////////////////////
                                        //Delete & Insert in Destination Table (Customer Destination Database)
                                        //////////////////////////////////////////////////////////////////////////////
                                            ...
                                            try
                                            {
                                                if (lsUpateMax != "")
                                                {
                                                    isSqlQuery = "MERGE INTO LS_MaxTime WITH(HOLDLOCK) AS a USING("
                                                                ...
                                                                //+ " a.[Table Name] = b.tblName And a.br_code = b.br "
